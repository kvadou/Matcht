...
class Profile extends Component {
        ...
        <div className="container">
            <div className="row">
                <div className="col-sm-6 offset-sm-2">
                    <h1>Welcome Back, <br />{profile[0].firstName} {profile[0].lastName} </h1>
                </div>
  ...
  <tbody>
    <tr>
      ...
      <td><a href={profile[0].savedJobs[0].link}> Link to Website </a></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      ...
      <td><a href={profile[0].savedJobs[1].link}> Link to Website</a></td>
    </tr>
    <tr>
      <th scope="row">3</th>
      ...
      <td><a href={profile[0].savedJobs[2].link}> Link to Website</a></td>
    </tr>
  </tbody>
</table>
